            ...
            <div class="row-fluid">
			 <?php include('sidebar.php'); ?>		
                <div class="span9" id="content">
                    <div class="row-fluid">
         	         <?php $query= mysql_query("select * from members where id = '$session_id'")or die(mysql_error());
...
<div id="page-wrapper">
        <?php 
		    $result = mysql_query("select *, SUm(Amount) AS value_sum from tithe where na='$session_id' "); 
		...
		<?php 
	    	$result1 = mysql_query("select *, SUm(Amount) AS value_sum from offering where na='$session_id' "); 
...
<div id="page-wrapper">
        <?php 
	    	$result2 = mysql_query("select *, SUm(Amount) AS value_sum from giving where na='$session_id' "); 
...
$sum2 = $row['value_sum'];
		...
		<?php 
	     $count_members=mysql_query("SELECT * 
FROm  members
