...
<table class=msoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <td width=188 style='width:140.9pt;border:solid windowtext 1.0pt;mso-border-alt:
  ...
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Date & Time <o:p></o:p></span></b></p>
   ...
   <!-- mYSQL FETCH ARRAY-->
<?php
		$student_query =  mysql_query("SELECT  student.username,fees.bank_name,fees.fee_paid,fees.time
FROm student  LEFT OUTER JOIN fees ON student.username = fees.regno WHERE fees.fee_paid !=0")or die(mysql_error());
